export default function BrandCampaignPage() {
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <h1 className="font-poppins text-3xl md:text-4xl font-bold text-[#001f3f] mb-4">Brand Campaign</h1>
      <p className="font-inter text-base text-[#003366] leading-relaxed mb-8">
        Multi-channel marketing strategy and execution driving brand awareness and customer engagement across digital and traditional media.
      </p>
      <div className="rounded-2xl border border-[#e8f1f7] bg-white p-6 shadow-sm">
        ...
        <p className="font-inter text-base text-[#003366] leading-relaxed">
          Detail the campaign strategy, creative direction, channels used, content calendar, and performance metrics (impressions, engagement, conversions, ROI).
        </p>
      </div>
    </div>
  );
